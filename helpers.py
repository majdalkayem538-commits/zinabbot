...
def get_user_row(user_id: int) -> dict:
    cursor.execute("""
        SELECT payment_status, order_id, selected_payment, selected_subjects, approved_subjects,
               support_pending, last_lecture_compound, form_step, cash_full_name, cash_student_number, cash_phone,
    ...
    if not row:
        return {
            ...
            "cash_student_number": None, "cash_phone": None, "cash_amount": None,
            "cash_subject_count": None, "cash_subject_names": None, "security_pin": None,
            "is_verified": 0, "session_expires_at": None, "pin_attempts": 0,
            "locked_until": None, "proof_message_id": None, "admin_message_id": None,
        }
    return {
        ...
        "cash_student_number": row["cash_student_number"],
