...
WELCOME_TEXT = """✨ أهلاً وسهلاً بك في بوت كورسات الرياضيات

هذا البوت مخصص لتسجيل الطلاب في المواد ومشاهدة المحاضرات الفيديو بعد قبول الدفع.
...
3) ما هي الحماية المضافة؟
الفيديوهات محمية داخل البوت، وتمت إضافة PIN أمان وجلسة دخول مؤقتة وترتيب إجباري للمحاضرات.

4) هل أستطيع إضافة محاضرات لاحقاً؟
نعم، الأدمن يمكنه إضافة مواد ومحاضرات من داخل البوت.

5) هل يمنع البوت 100% الدخول من هاتف ثانٍ على نفس حساب تيليغرام؟
لا يمكن ضمان ذلك تقنياً عبر Telegram Bot API، لكن تم تطبيق أقوى حماية عملية ممكنة داخل حدود البوت."""
