...
WELCOME_TEXT = """✨ أهلاً وسهلاً بكِ/بك في بوت المواد الجامعية

معك الآنسة زينب سلوم 🤍

من خلال البوت يمكنك بسهولة:
• تصفح المواد مرتبة حسب السنوات
• مشاهدة سعر كل مادة قبل التسجيل
• اختيار مادة واحدة أو أكثر
• إرسال طلب الدفع ومتابعة حالته
• الدخول فقط إلى المواد التي تم تفعيلها لك
• مشاهدة المحاضرات بشكل محمي ومرتب

🔐 الحماية داخل البوت:
• الفيديوهات محمية داخل تيليغرام
• دخول المحتوى يحتاج PIN أمان
• الجلسة تنتهي تلقائياً بعد مدة
• لا يمكن فتح محاضرة لاحقة قبل السابقة

📌 ابدأ من القائمة الرئيسية بالأسفل واختر ما يناسبك."""


FAQ_TEXT = """❓ الأسئلة الشائعة

1) هل أستطيع التسجيل بأكثر من مادة؟
نعم، يمكنك اختيار مادة واحدة أو أكثر.

2) هل تظهر لي كل المواد بعد الدفع؟
لا، فقط المواد التي تم قبولها وتفعيلها لك.

3) ماذا أفعل إذا كان طلبي قيد المراجعة؟
افتح زر "طلباتي" من القائمة الرئيسية لمتابعة حالة طلبك.

4) متى أحتاج إلى PIN؟
عند أول دخول للمحتوى أو بعد انتهاء الجلسة.

5) هل المحاضرات مرتبة؟
نعم، يجب متابعة المحاضرات بالتسلسل داخل كل مادة.
"""
...
LOG_FILE = os.path.join(APP_DATA_DIR, "bot.log")
BACKUP_DIR = os.path.join(APP_DATA_DIR, "backups")
BACKUP_INTERVAL_MINUTES = 60
PENDING_REMINDER_MINUTES = 30
PENDING_REMINDER_REPEAT_MINUTES = 120
