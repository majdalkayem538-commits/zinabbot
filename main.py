...
from maintenance import setup_logging, periodic_maintenance, send_startup_notice, error_handler
...
async def on_startup(app):
    ...
    await send_startup_notice(app)
    if _maintenance_task is None or _maintenance_task.done():
        _maintenance_task = asyncio.create_task(periodic_maintenance(app))
